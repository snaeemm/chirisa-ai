...
""",
    ...
    description="Smart database orchestrator with SQLite JSON optimization, automatic query intelligence, and seamless external agent coordination for missing data.",
